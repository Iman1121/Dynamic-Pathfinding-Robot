...
while running:
    ...
    point2 = point_on_line((walker.x, walker.y + walker.size), (player.x, player.y + player.size[0]), detection_range)
    point3 = point_on_line((walker.x + walker.size, walker.y), (player.x + player.size[0], player.y), detection_range)
    point4 = point_on_line((walker.x + walker.size, walker.y + walker.size), (player.x + player.size[0], player.y + player.size[0]), detection_range)
    point5 = point_on_line((walker.x, walker.y), (player.x, player.y), detection_range)
    obstructed = False
    for obstacle in obstacles:
        ...
        if center or corner1 or corner2 or corner3 or corner4:
            obstructed = True
    if obstructed:
        if walker.frontier != []:
    ...
    pygame.draw.line(screen, player_color, (walker.x, walker.y + walker.size), point2, 2)
    pygame.draw.line(screen, player_color, (walker.x + walker.size, walker.y), point3, 2)
    pygame.draw.line(screen, player_color, (walker.x + walker.size, walker.y + walker.size), point4, 2)
    pygame.draw.line(screen, player_color, (walker.x, walker.y), point5, 2)
